package org.firstinspires.ftc.pipelinuri;
...
public class PipelineStanga extends OpenCvPipeline {
    ...
    public static int region_of_interest = 2;
    ...
    public Mat processFrame(Mat input){
        ...
        Point P1L =  new Point(0, height - 100), P1R = new Point(width/2 - 100,height);
        Point P2L =  new Point(width/2-5, height - 100), P2R = new Point(width - 100,height);
        ...
        if ( valLeft > 800){                      // TODO calibrate tresholds
